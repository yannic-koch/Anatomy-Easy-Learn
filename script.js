...
function initAnatomyApp() {
  ...
  const muskelDaten = [
    ...
    { muskel: "M. iliopsoas", gruppe: "Hüfte (Innen)", ursprung: "12. Brust- und 1.–5. Lendenwirbelkörper (Psoas major); Fossa iliaca (Iliacus).", ansatz: "Gemeinsam am Trochanter minor des Femurs.", innervation: "N. femoralis (L1-4) sowie direkte Äste aus dem Plexus lumbalis.", funktion: "Hüftgelenk: Flexion und Außenrotation." },

    // --- BEIN: ÄUSSERE HÜFTMUSKELN ---
    { muskel: "M. gluteus maximus", gruppe: "Hüfte (Außen)", ursprung: "Facies dorsalis des Os sacrum, Facies glutea des Os ilium, Lig. sacrotuberale.", ansatz: "Tractus iliotibialis und Tuberositas glutea.", innervation: "N. gluteus inferior (L5-S2).", funktion: "Extension und Außenrotation im Hüftgelenk, Stabilisierung des Beckens." },
    { muskel: "M. gluteus medius", gruppe: "Hüfte (Außen)", ursprung: "Facies glutea des Os ilium.", ansatz: "Seitliche Fläche des Trochanter major am Femur.", innervation: "N. gluteus superior (L4-S1).", funktion: "Abduktion und Beckenstabilisierung in der Frontalebene." },
    { muskel: "M. gluteus minimus", gruppe: "Hüfte (Außen)", ursprung: "Facies glutea des Os ilium (unter dem M. gluteus medius).", ansatz: "Mediale Fläche des Trochanter major am Femur.", innervation: "N. gluteus superior (L4-S1).", funktion: "Abduktion und Beckenstabilisierung." },
    { muskel: "M. tensor fasciae latae", gruppe: "Hüfte (Außen)", ursprung: "Spina iliaca anterior superior.", ansatz: "Tractus iliotibialis.", innervation: "N. gluteus superior (L4-S1).", funktion: "Spannt die Fascia lata; Hüftgelenk: Abduktion, Flexion und Innenrotation." },
    { muskel: "M. piriformis", gruppe: "Hüfte (Außen)", ursprung: "Facies pelvica des Os sacrum.", ansatz: "Spitze des Trochanter major am Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Abduktion und Extension im Hüftgelenk; Stabilisierung." },
    { muskel: "M. obturatorius internus", gruppe: "Hüfte (Außen)", ursprung: "Innenfläche der Membrana obturatoria und an ihrem knöchernen Rahmen.", ansatz: "Fossa trochanterica am Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Adduktion und Extension im Hüftgelenk." },
    { muskel: "Mm. gemelli (superior und inferior)", gruppe: "Hüfte (Außen)", ursprung: "Spina ischiadica des Os ischii (superior); Tuber ischiadicum des Os ischii (inferior).", ansatz: "Zusammen mit der Ansatzsehne des M. obturatorius internus in der Fossa trochanterica.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Adduktion und Extension im Hüftgelenk." },
    { muskel: "M. quadratus femoris", gruppe: "Hüfte (Außen)", ursprung: "Lateraler Rand des Tuber ischiadicum des Os ischii.", ansatz: "Crista intertrochanterica des Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2) und/oder N. gluteus inferior.", funktion: "Außenrotation und Adduktion im Hüftgelenk." },
    ...
    { muskel: "M. pectineus", gruppe: "Adduktorengruppe", ursprung: "Pecten ossis pubis.", ansatz: "Linea pectinea und an der proximalen Linea aspera des Femur.", innervation: "N. femoralis (L1-4), N. obturatorius (L2-4).", funktion: "Adduktion, Außenrotation und leichte Flexion im Hüftgelenk." },
    ...
    { muskel: "M. adductor brevis", gruppe: "Adduktorengruppe", ursprung: "R. inferior des Os pubis.", ansatz: "Linea aspera (Labium mediale im oberen Femurdrittel).", innervation: "N. obturatorius (L2-4).", funktion: "Adduktion und Flexion (bis 70°) im Hüftgelenk." },
    ...
    { muskel: "M. biceps femoris", gruppe: "Oberschenkel (Flexoren)", ursprung: "Tuber ischiadicum (Caput longum); Labium laterale der Linea aspera (Caput breve).", ansatz: "Caput fibulae.", innervation: "N. tibialis (Caput longum); N. fibularis communis (Caput breve).", funktion: "Hüfte: Extension; Knie: Flexion und Außenrotation." },
    ...
    { muskel: "M. semitendinosus", gruppe: "Oberschenkel (Flexoren)", ursprung: "Tuber ischiadicum und Lig. sacrotuberale.", ansatz: "Medial der Tuberositas tibiae im Pes anserinus superficialis.", innervation: "N. tibialis (L5-S2).", funktion: "Hüftgelenk: Extension; Kniegelenk: Flexion und Innenrotation." },
    ...
    { muskel: "M. extensor digitorum longus", gruppe: "Unterschenkel (Extensoren)", ursprung: "Condylus lateralis tibiae, Caput fibulae, Membrana interossea cruris.", ansatz: "Dorsalaponeurosen der 2.–5. Zehe, Basen der Phalanges distales der 2.–5. Zehe.", innervation: "N. fibularis profundus (L4-S1).", funktion: "Dorsalextension, Eversion, Extension der Zehen." },
    { muskel: "M. extensor hallucis longus", gruppe: "Unterschenkel (Extensoren)", ursprung: "Mittleres Drittel der Facies medialis fibulae, Membrana interossea cruris.", ansatz: "Dorsalaponeurose der Großzehe, Basis ihrer Endphalanx.", innervation: "N. fibularis profundus (L5-S1).", funktion: "Dorsalextension, Extension der Großzehe." },
    { muskel: "M. fibularis longus", gruppe: "Unterschenkel (Fibularis)", ursprung: "Caput fibulae, proximale Facies lateralis fibulae.", ansatz: "Plantarseite des Os cuneiforme mediale, Basis des Os metatarsi I.", innervation: "N. fibularis superficialis (L5-S1).", funktion: "Plantarflexion, Eversion, Verspannung des Quergewölbes." },
    { muskel: "M. fibularis brevis", gruppe: "Unterschenkel (Fibularis)", ursprung: "Distale Hälfte der Facies lateralis fibulae.", ansatz: "Tuberositas ossis metatarsi V.", innervation: "N. fibularis superficialis (L5-S1).", funktion: "Plantarflexion, Eversion." },
    { muskel: "M. fibularis tertius", gruppe: "Unterschenkel (Fibularis)", ursprung: "Margo anterior der distalen Fibula.", ansatz: "Basis des Os metatarsi V.", innervation: "N. fibularis profundus (L4-S1).", funktion: "Dorsalextension, Eversion." },
    { muskel: "M. triceps surae", gruppe: "Unterschenkel (Flexoren)", ursprung: "Fibula, Arcus tendineus (Soleus); Epicondylus femoris (Gastrocnemius).", ansatz: "Tuber calcanei über die Achillessehne.", innervation: "N. tibialis (S1, 2).", funktion: "Plantarflexion, Inversion, Knieflexion (nur Gastrocnemius)." },
    { muskel: "M. plantaris", gruppe: "Unterschenkel (Flexoren)", ursprung: "Proximal des Caput laterale des M. gastrocnemius.", ansatz: "Tuber calcanei über die Achillessehne.", innervation: "N. tibialis (S1, 2).", funktion: "Verhindert bei Knieflexion Kompression der Vasa tibialia posteriora." },
    ...
    { muskel: "M. flexor hallucis longus", gruppe: "Unterschenkel (Tiefe Flexoren)", ursprung: "Distale zwei Drittel der Facies posterior fibulae, Membrana interossea cruris.", ansatz: "Basis der Endphalanx der Großzehe.", innervation: "N. tibialis (L5-S2).", funktion: "Plantarflexion, Inversion, Großzehenflexion." },
        ...
        <div class="main-layout">
          ...
          <div class="box">
            ...
            <div style="margin-bottom: 20px;">
              <strong style="color:var(--primary); font-size:0.95rem;">KATEGORIEN</strong><br>
            ...
            <div style="margin-bottom: 20px;">
              <strong style="color:var(--primary); font-size:0.95rem;">FRAGETYPEN</strong><br>
            ...
            <div style="margin-bottom: 25px; border-top: 1px solid var(--border-color); padding-top: 15px;">
              <label style="display:flex; justify-content:space-between; align-items:center;">
                <span style="font-weight:600; color:var(--text-main);">Max. Fragen (0 = alle):</span> 
                <input type="number" id="limit-input" value="10" min="0" style="width: 80px; margin:0; text-align:center;">
              </label>
            </div>
  ...
  function showQuestion() {
    ...
    if (q.type === 'write') {
      html += `
        <h2 style="font-size:1.6rem; color:var(--primary); margin-bottom:5px;">${q.muskel.muskel}</h2>
        <p style="color:var(--text-muted); font-size:0.95rem;">Kategorie: <strong>${q.kat.toUpperCase()}</strong> &nbsp;|&nbsp; Gruppe: ${q.muskel.gruppe}</p>
        <br>
        <label style="color:var(--text-main); font-weight:600; margin-bottom:10px;">Antwort eingeben:</label>
        <input type="text" id="write-answer" autofocus autocomplete="off" placeholder="Tippe deine Antwort hier...">
      ...
      html += `
        ...
        <p style="color:var(--text-muted); font-size:0.95rem;">Kategorie: <strong>${q.kat.toUpperCase()}</strong> &nbsp;|&nbsp; Gruppe: ${q.muskel.gruppe}</p>
        <br>
        <p style="font-weight:600; margin-bottom:15px; font-size:1.05rem;">Wähle die richtige Antwort:</p>
        <div class="option-list">
        ${options.map((opt) => `
          <label class="option-item">
            <input type="radio" name="single-opt" value="${opt.replace(/"/g, '&quot;')}"> 
            <span>${opt}</span>
          </label>
        `).join('')}
        </div>
      ...
      html += `
        <h2 style="font-size:1.6rem; color:var(--primary); margin-bottom:5px;">🔗 Zuordnung (Matching)</h2>
        <p style="color:var(--text-muted); font-size:0.95rem;">Kategorie: <strong>${currentCategory.toUpperCase()}</strong></p>
        <br>
        <p style="font-weight:600; margin-bottom:15px; font-size:1.05rem;">Ordne jedem Muskel den passenden Wert zu:</p>
  ...
  function saveAndRoute(userAns, correctAns, isCorrect) {
    ...
    if (currentMode === "PRACTICE") {
      ...
      feedbackArea.innerHTML = isCorrect 
        ? `✅ Exzellent! Die Antwort ist richtig.` 
        : `❌ Leider falsch.<br><br><strong style="color:#991b1b; font-size:0.9rem;">RICHTIGE LÖSUNG:</strong><br><span style="font-size:1.05rem;">${correctAns}</span>`;
    ...
    let html = `
      <div class="fade-in">
        <div style="text-align:center; padding: 20px 0;">
          <h1 style="background: none; -webkit-text-fill-color: var(--text-main); margin-bottom:10px;">🏁 Session beendet</h1>
          <h2 style="color: var(--primary); font-size:2.5rem; margin-bottom: 5px;">${scorePct}%</h2>
          <p style="color:var(--text-muted); font-size:1.1rem; margin-bottom: 25px;">Du hast ${correctCount} von ${total} Fragen richtig beantwortet.</p>
        </div>
    `;
            ...
            return `
              <div class="result-box ${ans.success ? 'result-correct' : 'result-wrong'}">
                <div style="font-size:1.1rem; margin-bottom:8px;">
                  ...
                  <span style="color:#64748b; font-size:0.85rem; float:right;">[${q.type.toUpperCase()}]</span>
                </div>
                <small style="color:#64748b; display:block; margin-bottom:12px; font-weight:500;">KATEGORIE: ${q.kat.toUpperCase()}</small>
                <div class="user-ans" style="margin-bottom:8px; line-height:1.4;">Deine Antwort:<br><strong style="color:var(--text-main); font-style:normal;">${ans.user}</strong></div>
                ${!ans.success ? `<div class="correct-ans" style="padding-top:8px; border-top:1px dashed #fecaca; line-height:1.4;">Richtige Lösung:<br><span style="color:#b91c1c;">${ans.correct}</span></div>` : ''}
              </div>
            `;
          }).join('')}
        </div>
        <button class="btn" onclick="window.renderMenu()" style="background:#1e293b; margin-top:20px; padding:16px; font-size:1.1rem;">🏠 Zurück zum Hauptmenü</button>
      </div>
    `;
