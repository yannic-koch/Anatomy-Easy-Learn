...
function initAnatomyApp() {
  ...
  const muskelDaten = [
    ...
    { muskel: "M. rectus capitis anterior", gruppe: "Prävertebrale Halsmuskeln", ursprung: "Massa lateralis des Atlas.", ansatz: "Pars basilaris des Os occipitale.", innervation: "R. ventralis des 1. Zervikalnervs.", funktion: "Ventralflexion im Atlantookzipitalgelenk." },
    { muskel: "M. rectus capitis lateralis", gruppe: "Prävertebrale Halsmuskeln", ursprung: "Proc. transversus des Atlas.", ansatz: "Pars lateralis des Os occipitale.", innervation: "R. ventralis des 1. Zervikalnervs.", funktion: "Lateralflexion im Atlantookzipitalgelenk." },
    ...
    { muskel: "M. serratus posterior superior", gruppe: "Rücken (Spinokostal)", ursprung: "Dornfortsätze des 6. und 7. Halswirbels sowie des 1. und 2. Brustwirbels.", ansatz: "2.-5. Rippe in Höhe des Angulus costae.", innervation: "Nn. intercostales Th1-4.", funktion: "Hebt die Rippen und unterstützt somit die Inspiration." },
    { muskel: "M. serratus posterior inferior", gruppe: "Rücken (Spinokostal)", ursprung: "Dornfortsätze des 11. und 12. Brustwirbels, des 1. und 2. Lendenwirbels sowie Fascia thoracolumbalis.", ansatz: "Unterrand der 9.-12. Rippe.", innervation: "Nn. intercostales Th9-12.", funktion: "Unterstützt Inspiration, stabilisiert das Zwerchfell." },

    // --- ARM: SCHULTERGÜRTELMUSKULATUR ---
    { muskel: "M. trapezius", gruppe: "Schultergürtelmuskulatur", ursprung: "Os occipitale, Lig. nuchae, Procc. spinosi aller Hals- und Brustwirbel.", ansatz: "laterales Drittel der Clavicula, Acromion, Spina scapulae.", innervation: "N. accessorius (XI. Hirnnerv) und Plexus cervicalis (C2-4).", funktion: "Fixiert das Schulterblatt am Thorax, zieht Scapula aufwärts/medial/kaudal." },
    ...
    { muskel: "M. omohyoideus", gruppe: "Schultergürtelmuskulatur", ursprung: "Margo superior des Schulterblatts.", ansatz: "Körper des Zungenbeins.", innervation: "Ansa cervicalis des Plexus cervicalis (C1-4).", funktion: "Absenkung des Zungenbeins, spannt die Halsfaszie." },
    { muskel: "M. serratus anterior", gruppe: "Schultergürtelmuskulatur", ursprung: "1.–9. Rippe.", ansatz: "Scapula (Angulus superior, Margo medialis, Angulus inferior).", innervation: "N. thoracicus longus (C5-7).", funktion: "Verschiebung der Scapula nach lateral-ventral, ermöglicht Arm-Elevation über 90°." },
    ...
    { muskel: "M. rhomboideus minor", gruppe: "Schultergürtelmuskulatur", ursprung: "Procc. spinosi der 6. und 7. Halswirbel.", ansatz: "Margo medialis der Scapula (oberhalb Spina scapulae).", innervation: "N. dorsalis scapulae (C4-5).", funktion: "Fixierung der Scapula, zieht sie nach kranial-medial." },
    { muskel: "M. rhomboideus major", gruppe: "Schultergürtelmuskulatur", ursprung: "Procc. spinosi der 1.–4. Brustwirbel.", ansatz: "Margo medialis der Scapula (unterhalb Spina scapulae).", innervation: "N. dorsalis scapulae (C4-5).", funktion: "Fixierung der Scapula, zieht sie nach kranial-medial." },
    ...
    { muskel: "M. deltoideus", gruppe: "Schultergelenk", ursprung: "Laterales Drittel Clavicula, Acromion, Spina scapulae.", ansatz: "Tuberositas deltoidea am Humerus.", innervation: "N. axillaris (C5, 6).", funktion: "Abduktion; Anteversion, Innenrotation; Retroversion, Außenrotation." },
    ...
    { muskel: "M. pectoralis major", gruppe: "Schultergelenk", ursprung: "Mediale Clavicula, Sternum, 2.–6. Rippenknorpel, Rektusscheide.", ansatz: "Crista tuberculi majoris des Humerus.", innervation: "Nn. pectorales medialis und lateralis (C5-Th1).", funktion: "Adduktion, Innenrotation, Anteversion." },
    ...
    { muskel: "M. triceps brachii", gruppe: "Oberarm", ursprung: "Tuberculum infraglenoidale (Caput longum), Hinterfläche des Humerus (Caput mediale/laterale).", ansatz: "Olecranon der Ulna.", innervation: "N. radialis (C6-8).", funktion: "Extension im Ellenbogen; Retroversion und Adduktion Schulter." },
    ...
    { muskel: "M. flexor carpi radialis", gruppe: "Unterarm (Flexoren)", ursprung: "Epicondylus medialis des Humerus.", ansatz: "Basis des Os metacarpi II.", innervation: "N. medianus (C6-8).", funktion: "Handgelenke: Flexion, Radialabduktion." },
    ...
    { muskel: "M. flexor digitorum profundus", gruppe: "Unterarm (Flexoren)", ursprung: "Beugeseite der Ulna, Membrana interossea.", ansatz: "Palmarseite der Endphalangen der Finger II-V.", innervation: "N. medianus (radial), N. ulnaris (ulnar).", funktion: "Flexion in Hand-, Grund-, Mittel- und Endgelenken." },
    ...
    // --- ARM: UNTERARMMUSKULATUR (EXTENSOREN & RADIALIS) ---
    { muskel: "M. brachioradialis", gruppe: "Unterarm (Extensoren)", ursprung: "Laterale Seite des distalen Humerus.", ansatz: "Proc. styloideus radii.", innervation: "N. radialis (C5-7).", funktion: "Flexion im Ellenbogen, Semipronationsstellung." },
    { muskel: "M. extensor carpi radialis longus", gruppe: "Unterarm (Extensoren)", ursprung: "Laterale Seite des distalen Humerus (Crista supracondylaris lateralis).", ansatz: "Dorsale Basis des Os metacarpi II.", innervation: "N. radialis (C5-7).", funktion: "Handgelenke: Dorsalextension, Radialabduktion." },
    ...
    { muskel: "M. supinator", gruppe: "Unterarm (Extensoren)", ursprung: "Olecranon, Epicondylus lateralis, Lig. collaterale radiale/anulare.", ansatz: "Radius.", innervation: "N. radialis (C5, 6).", funktion: "Supination." },
    ...
    // --- ARM: KURZE HANDMUSKELN (EINZELN) ---
    { muskel: "M. abductor pollicis brevis", gruppe: "Hand (Thenar)", ursprung: "Os scaphoideum, Retinaculum musculorum flexorum.", ansatz: "Basis der Daumengrundphalanx (radiales Sesambein).", innervation: "N. medianus (C6, 7).", funktion: "Daumensattelgelenk Abduktion, Grundgelenk Flexion." },
    { muskel: "M. adductor pollicis", gruppe: "Hand (Thenar/Mittelhand)", ursprung: "3. Mittelhandknochen, Os capitatum, Basis Ossa metatarsi II-III.", ansatz: "Basis der Daumengrundphalanx (ulnares Sesambein).", innervation: "N. ulnaris (C8-Th1).", funktion: "Daumensattelgelenk Adduktion, Opposition." },
    { muskel: "M. flexor pollicis brevis", gruppe: "Hand (Thenar)", ursprung: "Retinaculum mm. flexorum, Os capitatum, Os trapezium.", ansatz: "Basis der Daumengrundphalanx (radiales Sesambein).", innervation: "N. medianus (Caput superficiale) & N. ulnaris (Caput profundum).", funktion: "Daumen Flexion und Opposition." },
    { muskel: "M. opponens pollicis", gruppe: "Hand (Thenar)", ursprung: "Os trapezium.", ansatz: "Radialer Rand des 1. Mittelhandknochens.", innervation: "N. medianus (C6, 7).", funktion: "Daumensattelgelenk Opposition." },
    { muskel: "M. abductor digiti minimi (Hand)", gruppe: "Hand (Hypothenar)", ursprung: "Os pisiforme.", ansatz: "Ulnare Basis der Grundphalanx und Dorsalaponeurose 5. Finger.", innervation: "N. ulnaris (C8-Th1).", funktion: "Kleinfinger Abduktion und Flexion." },
    { muskel: "M. flexor digiti minimi brevis (Hand)", gruppe: "Hand (Hypothenar)", ursprung: "Hamulus ossis hamati, Retinaculum mm. flexorum.", ansatz: "Basis der Grundphalanx des 5. Fingers.", innervation: "N. ulnaris (C8-Th1).", funktion: "Kleinfingergrundgelenk Flexion." },
    { muskel: "M. opponens digiti minimi (Hand)", gruppe: "Hand (Hypothenar)", ursprung: "Hamulus ossis hamati.", ansatz: "Ulnarer Rand des 5. Mittelhandknochens.", innervation: "N. ulnaris (C8-Th1).", funktion: "Opposition des Kleinfingers." },
    { muskel: "Mm. lumbricales I-IV (Hand)", gruppe: "Hand (Mittelhand)", ursprung: "Radiale Seiten der Sehnen des M. flexor digitorum profundus.", ansatz: "Dorsalaponeurosen des 2.–5. Fingers.", innervation: "N. medianus (I+II), N. ulnaris (III+IV) (C8-Th1).", funktion: "Grundgelenk Flexion, Mittel-/Endgelenk Extension." },
    { muskel: "Mm. interossei dorsales I-IV (Hand)", gruppe: "Hand (Mittelhand)", ursprung: "Einander zugekehrte Seiten der Ossa metatarsi I-V (zweiköpfig).", ansatz: "Dorsalaponeurose 2.-4. Finger, Basis proximale Phalanx.", innervation: "N. ulnaris (C8-Th1).", funktion: "Grundgelenk Flexion, Endgelenk Extension, Spreizen der Finger." },
    { muskel: "Mm. interossei palmares I-III (Hand)", gruppe: "Hand (Mittelhand)", ursprung: "Ulnare Seite 2., radiale Seite 4. und 5. Mittelhandknochen.", ansatz: "Dorsalaponeurose und Basis der proximalen Phalanx.", innervation: "N. ulnaris (C8-Th1).", funktion: "Schließen der gespreizten Finger (Adduktion zum Mittelfinger)." },

    // --- BEIN: HÜFTE ---
    { muskel: "M. psoas major", gruppe: "Bein: Innere Hüftmuskeln", ursprung: "Seitenflächen 12. Brust- bis 4. Lendenwirbelkörper sowie Disci intervertebrales.", ansatz: "Trochanter minor des Femurs.", innervation: "Direkte Äste aus Plexus lumbalis und N. femoralis (L1-4).", funktion: "Hüftgelenk: Flexion und Außenrotation." },
    { muskel: "M. iliacus", gruppe: "Bein: Innere Hüftmuskeln", ursprung: "Fossa iliaca.", ansatz: "Trochanter minor des Femurs (gemeinsam mit Psoas major als M. iliopsoas).", innervation: "N. femoralis (L1-4).", funktion: "Hüftgelenk: Flexion und Außenrotation." },
    { muskel: "M. gluteus maximus", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Facies dorsalis des Os sacrum, hinterer Teil Facies glutea des Os ilium, Fascia thoracolumbalis.", ansatz: "Tractus iliotibialis (kranial) und Tuberositas glutea (kaudal).", innervation: "N. gluteus inferior (L5-S2).", funktion: "Extension und Außenrotation im Hüftgelenk, Stabilisierung des Beckens." },
    { muskel: "M. gluteus medius", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Facies glutea des Os ilium (zwischen Linea glutea anterior und posterior).", ansatz: "Seitliche Fläche des Trochanter major am Femur.", innervation: "N. gluteus superior (L4-S1).", funktion: "Abduktion und Beckenstabilisierung." },
    { muskel: "M. gluteus minimus", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Facies glutea des Os ilium (unter M. gluteus medius).", ansatz: "Mediale Fläche des Trochanter major am Femur.", innervation: "N. gluteus superior (L4-S1).", funktion: "Abduktion und Beckenstabilisierung." },
    { muskel: "M. tensor fasciae latae", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Spina iliaca anterior superior.", ansatz: "Tractus iliotibialis.", innervation: "N. gluteus superior (L4-S1).", funktion: "Spannt die Fascia lata; Hüftgelenk: Abduktion, Flexion und Innenrotation." },
    { muskel: "M. piriformis", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Facies pelvica des Os sacrum.", ansatz: "Spitze des Trochanter major am Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Abduktion und Extension im Hüftgelenk." },
    { muskel: "M. obturatorius internus", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Innenfläche der Membrana obturatoria und knöcherner Rahmen.", ansatz: "Fossa trochanterica am Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Adduktion und Extension im Hüftgelenk." },
    { muskel: "Mm. gemelli (superior und inferior)", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Spina ischiadica (sup.) / Tuber ischiadicum (inf.) des Os ischii.", ansatz: "Zusammen mit M. obturatorius internus in der Fossa trochanterica.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2).", funktion: "Außenrotation, Adduktion und Extension im Hüftgelenk." },
    { muskel: "M. quadratus femoris", gruppe: "Bein: Äußere Hüftmuskeln", ursprung: "Lateraler Rand des Tuber ischiadicum des Os ischii.", ansatz: "Crista intertrochanterica des Femur.", innervation: "Direkte Äste aus dem Plexus sacralis (L5-S2) und/oder N. gluteus inferior.", funktion: "Außenrotation und Adduktion im Hüftgelenk." },

    // --- BEIN: ADDUKTOREN ---
    { muskel: "M. obturatorius externus", gruppe: "Bein: Adduktoren", ursprung: "Außenseite der Membrana obturatoria und angrenzender Knochen.", ansatz: "Fossa trochanterica des Femur.", innervation: "N. obturatorius (L2-4).", funktion: "Adduktion und Außenrotation im Hüftgelenk." },
    ...
    { muskel: "M. rectus femoris", gruppe: "Bein: Oberschenkel", ursprung: "Spina iliaca anterior inferior (Caput rectum), Pfannendach (Caput reflexum).", ansatz: "Tuberositas tibiae via Lig. patellae (als Teil des Quadriceps).", innervation: "N. femoralis (L1-4).", funktion: "Hüftgelenk: Flexion; Kniegelenk: Extension." },
    ...
    { muskel: "M. biceps femoris", gruppe: "Bein: Oberschenkel", ursprung: "Tuber ischiadicum (Caput longum); Labium laterale der Linea aspera (Caput breve).", ansatz: "Caput fibulae.", innervation: "N. tibialis (Caput longum); N. fibularis communis (Caput breve).", funktion: "Hüfte: Extension; Knie: Flexion und Außenrotation." },
    ...
    { muskel: "M. extensor hallucis longus", gruppe: "Bein: Unterschenkel", ursprung: "Mittleres Drittel der Facies medialis fibulae, Membrana interossea.", ansatz: "Dorsalaponeurose der Großzehe, Basis ihrer Endphalanx.", innervation: "N. fibularis profundus (L5-S1).", funktion: "Dorsalextension, Großzehenextension." },
    ...
    { muskel: "M. gastrocnemius", gruppe: "Bein: Unterschenkel", ursprung: "Epicondylus medialis und lateralis femoris.", ansatz: "Tuber calcanei über die Achillessehne.", innervation: "N. tibialis (S1, 2).", funktion: "Plantarflexion, Supination, Knieflexion." },
    { muskel: "M. soleus", gruppe: "Bein: Unterschenkel", ursprung: "Dorsalseite Caput/Collum fibulae und Linea musculi solei der Tibia.", ansatz: "Tuber calcanei über die Achillessehne.", innervation: "N. tibialis (S1, 2).", funktion: "Plantarflexion, Supination." },
    ...
    { muskel: "M. tibialis posterior", gruppe: "Bein: Unterschenkel", ursprung: "Membrana interossea cruris, Ränder von Tibia und Fibula.", ansatz: "Tuberositas ossis navicularis, Ossa cuneiformia, Basen Ossa metatarsi II-IV.", innervation: "N. tibialis (L4-S1).", funktion: "Plantarflexion, Inversion, Gewölbeverspannung." },
    ...
    // --- BEIN: FUSS ---
    { muskel: "M. extensor digitorum brevis", gruppe: "Bein: Fuß", ursprung: "Dorsalfläche des Calcaneus.", ansatz: "Dorsalaponeurose der 2.–4. Zehe, Basen der Mittelphalangen.", innervation: "N. fibularis profundus (L5-S1).", funktion: "Dorsalextension der 2.–4. Zehe." },
    ...
    { muskel: "M. flexor hallucis brevis", gruppe: "Bein: Fuß", ursprung: "Os cuneiforme mediale, intermedium, Lig. calcaneocuboideum plantare.", ansatz: "Basis der Grundphalanx I über die Sesambeine.", innervation: "N. plantaris medialis / lateralis.", funktion: "Plantarflexion im Großzehengrundgelenk." },
